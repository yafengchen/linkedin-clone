    ...
    <div className="navbar-container">
      <div className="navbar-left">
        ...
        <div className="navbar-search-container">
          ...
          <input className="navbar-search" type="text"></input>
        </div>
      </div>
      <div className="navbar-right">
        <div className="navbar-element">
          ...
          <p className="navbar-img-name">Home</p>
        </div>
        <div className="navbar-element">
          ...
          <p className="navbar-img-name">My Network</p>
        </div>
        <div className="navbar-element">
          ...
          <p className="navbar-img-name">Jobs</p>
        </div>
        <div className="navbar-element">
          ...
          <p className="navbar-img-name">Messaging</p>
        </div>
        <div className="navbar-element">
          <svg
          ...
          <p className="navbar-img-name">Notifications</p>
        </div>
        <div className="navbar-element">
          <Avatar style={{ height: "30px", width: "30px" }}>H</Avatar>
          <p className="navbar-img-name">Me</p>
        </div>
      </div>
      <div className="navbar-more">
        <div className="navbar-element">
          ...
          <p className="navbar-img-name">Work</p>
        </div>
        <p className="premium">Try Premium Free for 1 Month</p>
      </div>
    </div>
  );
}
